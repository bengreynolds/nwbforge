...
4. Expand the concrete PySide6 widget baseline with richer shell navigation, broader session-loading support, and app-level log/report configuration.
