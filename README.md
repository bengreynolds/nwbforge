...
4. Build install-execution services on top of `PackageManagementService` so future setup and `File -> Install Extensions / Packages` screens can report progress and failures cleanly.
