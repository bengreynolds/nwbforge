...
3. Expand the new direct-ingest `New Session` workflow from the current role-assignment and session-wide override baseline into richer grouping and source-specific metadata handling.
