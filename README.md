...
4. Add background runtime wrappers around `PackageInstallationService` so future setup and `File -> Install Extensions / Packages` screens can run installs off the UI thread.
