...
4. Expand the concrete PySide6 widget baseline with broader session-loading support, richer conversion/review detail, and app-level log configuration.
