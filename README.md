...
3. Harden operational concerns such as richer review history, recovery flows, and report visibility on top of the current latest-state persistence baseline.
