...
3. Expand the new direct-ingest `New Session` workflow from the current heuristic-grouping, manual regrouping, simple sidecar association, explicit project baseline, and current session/source override model into richer dataset grouping and post-preview disagreement handling.
