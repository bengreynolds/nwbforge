...
ROUTE_PACKAGE_CATALOG: tuple[RoutePackageSpec, ...] = (
    ...
    RoutePackageSpec(
        ...
        description="Blackrock NSx recording support through NeuroConv's blackrock extra.",
        required_modules=("spikeinterface",),
        implemented_in_code=True,
    ),
    RoutePackageSpec(
    ...
    RoutePackageSpec(
        ...
        description="Neuralynx recording support through NeuroConv's neuralynx extra.",
    ...
    RoutePackageSpec(
        ...
        display_name="Plexon",
        extra_name="plexon",
        description="Plexon `.plx` recording support through NeuroConv's plexon extra.",
        required_modules=("spikeinterface",),
        implemented_in_code=True,
    ),
    RoutePackageSpec(
